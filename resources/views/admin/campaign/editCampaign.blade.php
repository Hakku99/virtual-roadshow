            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-content">
                        ...
                        <h2>You are now editing campaign <span style="color: #F48840; font-size: 55px">
                ...
                <div class="content">
                    <div class="col-md-12 col-sm-12">
                        <fieldset>
                            ...
                            <label>CURRENT CAMPAIGN IMAGE</label>
                            <div class="container">
                                @if (count($errors) > 0)
                                ...
                                <img
                                    src="/assets/uploaded_images/campaign_images//{{$campaign->name}}//{{ $campaign->image_name }}"
                                    width="300"/>
                                <form method="post" action="{{url('/updateCampaign', $campaign->id)}}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-8">
                                            @if (session()->get('url_errors'))
                                                <div class="alert alert-danger">
                                                    <ul>
                                                        Please Upload a new valid youtube video URL<br>
                                                    </ul>
                                                </div>
                                            @endif
                                            <fieldset>
                                                ...
                                                <br>
                                                <iframe width="300"
                                                        src="https://www.youtube.com/embed/{{$campaign->video_id}}?autoplay=1"
                                                        allowfullscreen
                                                ...
                                                <p style="margin-bottom: 30px; color:black">Please insert a new Youtube video url here if you
                                                    want to change</p>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-12 col-sm-12">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <fieldset>
                                                ...
                                                <textarea id="section1" name="section1" rows="3"
                                                          placeholder="ELABORATION 1"></textarea>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-6 col-sm-12">
                                            <fieldset>
                                                ...
                                                <textarea id="section2" name="section2" rows="3"
                                                          placeholder="ELABORATION 2 (Optional)"></textarea>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-12 col-sm-12">
                                            <fieldset>
                                                ...
                                                <textarea id="section3" name="section3" rows="3"
                                                          placeholder="ELABORATION 3 (Optional)"></textarea>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-6 col-sm-12">
                                            <fieldset>
...
<script>
    ...
    $(function () {
        ...
        $('#start_date').val(decodeHtml('{{$campaign->start_date}}'));
        $('#end_date').val(decodeHtml('{{$campaign->end_date}}'));
        $('#section1').val(decodeHtml('{{$campaign->section1}}'));
        $('#section2').val(decodeHtml('{{$campaign->section2}}'));
        $('#section3').val(decodeHtml('{{$campaign->section3}}'));
        $('#contact_email').val(decodeHtml('{{$campaign->contact_email}}'));
        $('#contact_number').val(decodeHtml('{{$campaign->contact_number}}'));
    });
</script>
